 ...
 */
public class Bw_mapView extends AppCompatActivity implements RadarUploadInfoCallback,RadarSearchListener {
   ...
   PagerAdapter pagerAdapter;
    ...
    public void onClick(View v){
        startActivity(new Intent(getApplicationContext(),Bw_details.class));
    }
